...
function activateQuickAccess() {
    /**
    * Le actualQALevel correspond au nom du niveau actuellement activé.
    * Par exemple au chargement il va être au niveau racine (ou null ou 0)
    * => auquel cas il "active" tout les éléments du niveau racine
    * Un élément activé est un élément qui affiche une infobulle et qui est écouté par le système pour déclencher une action
    * Si "menu_navigation" est activé, alors il affiche les lettres pour le menu_navigation et tout
    * les sous-éléments immédiats, mais désactive les autres.
    */
    let actualQALevel = null // Correspond au niveau racine
