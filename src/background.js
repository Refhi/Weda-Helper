...
const NoemieReplaceDictDefault = JSON.stringify({
...
var advancedDefaultSettings = [
    {
        ...
        "name": "Options des NOEMIE",
        "description": "Des options spécifiques a la gestion des NOEMIE",
        "type": TYPE_TITLE,
        "options": [{
            "name": "NoemieReplaceDict",
            "type": TYPE_JSON,
            "description": "Liste des NOEMIE avec leur valeur de remplacement lors de la saisie des NOEMIE",
            "default": NoemieReplaceDictDefault
        }]
    }, {
        "name": "Options de FSE",
